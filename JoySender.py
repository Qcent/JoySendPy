...
def flush_HID_buffer(gamepad, clock):
    ...
    elapsed_time = start_time - clock.last_frame_time
    ...
    clock.last_frame_time = start_time
...
def joySender(operational_mode, auto_select):
    ...
    if operational_mode == 3:
        ...
        ds4_output_report[8] = 105  # R
        ds4_output_report[9] = 4    # G
        ds4_output_report[10] = 32  # B
    ...
    while True:
        ...
        while client_socket:
            ...
            if operational_mode == 2:
                ...
                flush_HID_buffer(gamepad, clock)
            else:
                clock.tick()
